			...
			<div className="py-10 bg-white md:py-16">
				<div className="px-10 mx-auto max-w-7xl md:px-16">
					<div className="max-w-3xl mx-auto mb-10 md:mb-16">
						<h2 className="text-4xl tracking-wide font-black text-blue-950 mb-6 lg:text-4xl text-center md:mt-2">
							Request A Quote
						</h2>
					</div>
					<form className="grid max-w-3xl gap-4 mx-auto sm:grid-cols-2">
						<div>
							<p className="inline-block mb-2 text-lg font-medium text-gray-500 sm:text-lg">
								First name
							</p>
							<input
								name="first-name"
