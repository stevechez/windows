...
const Services: NextPage = () => {
  return (
    <div className="container w-4/5 mx-auto py-10">
      ...
      <ol className="list-disc ml-6 mt-4 w-full">
        <li className="text-lg mb-4 w-full">
      ...
      Screen Cleaning: We provide screen cleaning services for your windows and
      doors, removing dirt and dust to improve visibility and air flow.
